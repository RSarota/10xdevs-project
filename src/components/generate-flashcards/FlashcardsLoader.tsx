import { Stack, Body, Title3, ActivityIndicator } from "@/components/apple-hig";
...
export function FlashcardsLoader({
  ...
  return (
    <div data-testid="flashcards-loader">
      <Stack direction="vertical" spacing="lg" align="center" className="py-12">
